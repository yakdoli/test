...
<!-- tags: [Syncfusion-sdk, Essential Studio, Installation, Deployment, Windows Forms, Samples, License, Patches, Version 11.4.0.26] keywords: [Installation, Deployment, Samples, UG, Common UG, Syncfusion, Windows Forms, Version number, Sample browser, Source code, Add, Remove Components] -->
```